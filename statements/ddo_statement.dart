...
class DDOStatement {
  ...
  void bindParam(Object mixed, String variable, [int type = null, int length =
      null]) {
    if (mixed is String) {
  ...
  void bindValue(Object mixed, String variable, [int type = null, int length =
      null]) {
    bindParam(mixed, variable, type, length);
  }

  bool bindColumn(Object mixed, Object param, [int type = null, int maxLength =
      null, Object driverOption = null]) {
    //Not supported.
  	return false;
  }
